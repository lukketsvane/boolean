  ...
  const calculateIntersection = useCallback(() => {
    ...
    if (showIntersection) {
      if (primitive1Ref.current) {
        primitive1Ref.current.material.opacity = 0.2
        primitive1Ref.current.visible = true
      }
      if (primitive2Ref.current) {
        primitive2Ref.current.material.opacity = 0.2
        primitive2Ref.current.visible = true
      }
    } else {
      if (primitive1Ref.current) {
        primitive1Ref.current.visible = false
      }
      if (primitive2Ref.current) {
        primitive2Ref.current.visible = false
      }
    }
...
export function 3dPrimitiveIntersection() {
  ...
  const [position1, setPosition1] = useState([25, 0, 0])
